...
export function FacilityContent({ facility }: { facility: FacilityData }) {
    return (
        <>
            {/* Hero */}
            <section className="relative overflow-hidden gradient-hero py-14 sm:py-20 md:py-28">
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 text-white">
                    ...
                    <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold mb-2 sm:mb-4">{facility.title}</h1>
                    <p className="text-white/80 text-sm sm:text-lg max-w-3xl">{facility.description}</p>
                </div>
                                ...
                                <Card className="border-0 shadow-soft rounded-2xl lg:sticky lg:top-28">
                                    <CardContent className="p-5 sm:p-8">
                                        ...
                                        <p className="text-muted-foreground text-xs sm:text-sm mb-4 sm:mb-6">
                                            Contact us for more information or to avail this facility.
                                        </p>
